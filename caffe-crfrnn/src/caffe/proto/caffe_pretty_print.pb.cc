...
// source: crfasrnn_caffe_pretty_print.proto
...
void protobuf_AssignDesc_crfasrnn_5fcaffe_5fpretty_5fprint_2eproto() {
  protobuf_AddDesc_crfasrnn_5fcaffe_5fpretty_5fprint_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "crfasrnn_caffe_pretty_print.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_crfasrnn_5fcaffe_5fpretty_5fprint_2eproto);
}
...
void protobuf_ShutdownFile_crfasrnn_5fcaffe_5fpretty_5fprint_2eproto() {
  delete NetParameterPrettyPrint::default_instance_;
  delete NetParameterPrettyPrint_reflection_;
}

void protobuf_AddDesc_crfasrnn_5fcaffe_5fpretty_5fprint_2eproto() {
  static bool already_here = false;
  if (already_here) return;
  already_here = true;
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  ::crfasrnn_caffe::protobuf_AddDesc_crfasrnn_5fcaffe_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n!crfasrnn_caffe_pretty_print.proto\022\016crf"
    "asrnn_caffe\032\024crfasrnn_caffe.proto\"\230\001\n\027Ne"
    "tParameterPrettyPrint\022\014\n\004name\030\001 \001(\t\022\035\n\016f"
    "orce_backward\030\002 \001(\010:\005false\022\r\n\005input\030\003 \003("
    "\t\022\021\n\tinput_dim\030\004 \003(\005\022.\n\006layers\030\005 \003(\0132\036.c"
    "rfasrnn_caffe.LayerParameter", 228);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "crfasrnn_caffe_pretty_print.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_crfasrnn_5fcaffe_5fpretty_5fprint_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_crfasrnn_5fcaffe_5fpretty_5fprint_2eproto {
  StaticDescriptorInitializer_crfasrnn_5fcaffe_5fpretty_5fprint_2eproto() {
    protobuf_AddDesc_crfasrnn_5fcaffe_5fpretty_5fprint_2eproto();
  }
} static_descriptor_initializer_crfasrnn_5fcaffe_5fpretty_5fprint_2eproto_;
...
NetParameterPrettyPrint::NetParameterPrettyPrint()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:crfasrnn_caffe.NetParameterPrettyPrint)
}
...
NetParameterPrettyPrint::NetParameterPrettyPrint(const NetParameterPrettyPrint& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:crfasrnn_caffe.NetParameterPrettyPrint)
}
...
NetParameterPrettyPrint::~NetParameterPrettyPrint() {
  // @@protoc_insertion_point(destructor:crfasrnn_caffe.NetParameterPrettyPrint)
  SharedDtor();
}
...
const NetParameterPrettyPrint& NetParameterPrettyPrint::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_crfasrnn_5fcaffe_5fpretty_5fprint_2eproto();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:crfasrnn_caffe.NetParameterPrettyPrint)
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (tag == 10) {
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            "crfasrnn_caffe.NetParameterPrettyPrint.name");
        } else {
          goto handle_unusual;
        }
        ...
        if (tag == 26) {
         parse_input:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            ::google::protobuf::internal::WireFormat::PARSE,
            "crfasrnn_caffe.NetParameterPrettyPrint.input");
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(26)) goto parse_input;
      ...
      // repeated .crfasrnn_caffe.LayerParameter layers = 5;
      case 5: {
        if (tag == 42) {
         parse_layers:
...
success:
  // @@protoc_insertion_point(parse_success:crfasrnn_caffe.NetParameterPrettyPrint)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:crfasrnn_caffe.NetParameterPrettyPrint)
  return false;
#undef DO_
}
...
void NetParameterPrettyPrint::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:crfasrnn_caffe.NetParameterPrettyPrint)
  // optional string name = 1;
  if (has_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->name().data(), this->name().length(),
  ...
  // @@protoc_insertion_point(serialize_end:crfasrnn_caffe.NetParameterPrettyPrint)
}

::google::protobuf::uint8* NetParameterPrettyPrint::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:crfasrnn_caffe.NetParameterPrettyPrint)
  // optional string name = 1;
  if (has_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->name().data(), this->name().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:crfasrnn_caffe.NetParameterPrettyPrint)
  return target;
}
...
void NetParameterPrettyPrint::clear_name() {
 ...
 const ::std::string& NetParameterPrettyPrint::name() const {
  // @@protoc_insertion_point(field_get:crfasrnn_caffe.NetParameterPrettyPrint.name)
  return name_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 void NetParameterPrettyPrint::set_name(const ::std::string& value) {
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:crfasrnn_caffe.NetParameterPrettyPrint.name)
}
 void NetParameterPrettyPrint::set_name(const char* value) {
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:crfasrnn_caffe.NetParameterPrettyPrint.name)
}
 void NetParameterPrettyPrint::set_name(const char* value, size_t size) {
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:crfasrnn_caffe.NetParameterPrettyPrint.name)
}
 ::std::string* NetParameterPrettyPrint::mutable_name() {
  set_has_name();
  // @@protoc_insertion_point(field_mutable:crfasrnn_caffe.NetParameterPrettyPrint.name)
 ...
 void NetParameterPrettyPrint::set_allocated_name(::std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:crfasrnn_caffe.NetParameterPrettyPrint.name)
}
...
void NetParameterPrettyPrint::clear_force_backward() {
 ...
 bool NetParameterPrettyPrint::force_backward() const {
  // @@protoc_insertion_point(field_get:crfasrnn_caffe.NetParameterPrettyPrint.force_backward)
  return force_backward_;
}
 void NetParameterPrettyPrint::set_force_backward(bool value) {
  set_has_force_backward();
  force_backward_ = value;
  // @@protoc_insertion_point(field_set:crfasrnn_caffe.NetParameterPrettyPrint.force_backward)
}
...
void NetParameterPrettyPrint::clear_input() {
 ...
 const ::std::string& NetParameterPrettyPrint::input(int index) const {
  // @@protoc_insertion_point(field_get:crfasrnn_caffe.NetParameterPrettyPrint.input)
  return input_.Get(index);
}
 ::std::string* NetParameterPrettyPrint::mutable_input(int index) {
  // @@protoc_insertion_point(field_mutable:crfasrnn_caffe.NetParameterPrettyPrint.input)
  return input_.Mutable(index);
}
 void NetParameterPrettyPrint::set_input(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:crfasrnn_caffe.NetParameterPrettyPrint.input)
  input_.Mutable(index)->assign(value);
}
 void NetParameterPrettyPrint::set_input(int index, const char* value) {
  input_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:crfasrnn_caffe.NetParameterPrettyPrint.input)
}
 void NetParameterPrettyPrint::set_input(int index, const char* value, size_t size) {
  input_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:crfasrnn_caffe.NetParameterPrettyPrint.input)
}
 ...
 void NetParameterPrettyPrint::add_input(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:crfasrnn_caffe.NetParameterPrettyPrint.input)
}
 void NetParameterPrettyPrint::add_input(const char* value) {
  input_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:crfasrnn_caffe.NetParameterPrettyPrint.input)
}
 void NetParameterPrettyPrint::add_input(const char* value, size_t size) {
  input_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:crfasrnn_caffe.NetParameterPrettyPrint.input)
}
 const ::google::protobuf::RepeatedPtrField< ::std::string>&
NetParameterPrettyPrint::input() const {
  // @@protoc_insertion_point(field_list:crfasrnn_caffe.NetParameterPrettyPrint.input)
  return input_;
}
 ::google::protobuf::RepeatedPtrField< ::std::string>*
NetParameterPrettyPrint::mutable_input() {
  // @@protoc_insertion_point(field_mutable_list:crfasrnn_caffe.NetParameterPrettyPrint.input)
  return &input_;
}
...
void NetParameterPrettyPrint::clear_input_dim() {
 ...
 ::google::protobuf::int32 NetParameterPrettyPrint::input_dim(int index) const {
  // @@protoc_insertion_point(field_get:crfasrnn_caffe.NetParameterPrettyPrint.input_dim)
 ...
 void NetParameterPrettyPrint::set_input_dim(int index, ::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:crfasrnn_caffe.NetParameterPrettyPrint.input_dim)
}
 void NetParameterPrettyPrint::add_input_dim(::google::protobuf::int32 value) {
  input_dim_.Add(value);
  // @@protoc_insertion_point(field_add:crfasrnn_caffe.NetParameterPrettyPrint.input_dim)
}
 const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
NetParameterPrettyPrint::input_dim() const {
  // @@protoc_insertion_point(field_list:crfasrnn_caffe.NetParameterPrettyPrint.input_dim)
  return input_dim_;
}
 ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
NetParameterPrettyPrint::mutable_input_dim() {
  // @@protoc_insertion_point(field_mutable_list:crfasrnn_caffe.NetParameterPrettyPrint.input_dim)
  return &input_dim_;
}
...
const ::crfasrnn_caffe::LayerParameter& NetParameterPrettyPrint::layers(int index) const {
  // @@protoc_insertion_point(field_get:crfasrnn_caffe.NetParameterPrettyPrint.layers)
  return layers_.Get(index);
}
::crfasrnn_caffe::LayerParameter* NetParameterPrettyPrint::mutable_layers(int index) {
  // @@protoc_insertion_point(field_mutable:crfasrnn_caffe.NetParameterPrettyPrint.layers)
  return layers_.Mutable(index);
}
::crfasrnn_caffe::LayerParameter* NetParameterPrettyPrint::add_layers() {
  // @@protoc_insertion_point(field_add:crfasrnn_caffe.NetParameterPrettyPrint.layers)
  return layers_.Add();
}
::google::protobuf::RepeatedPtrField< ::crfasrnn_caffe::LayerParameter >*
NetParameterPrettyPrint::mutable_layers() {
  // @@protoc_insertion_point(field_mutable_list:crfasrnn_caffe.NetParameterPrettyPrint.layers)
  return &layers_;
}
const ::google::protobuf::RepeatedPtrField< ::crfasrnn_caffe::LayerParameter >&
NetParameterPrettyPrint::layers() const {
  // @@protoc_insertion_point(field_list:crfasrnn_caffe.NetParameterPrettyPrint.layers)
  return layers_;
}
