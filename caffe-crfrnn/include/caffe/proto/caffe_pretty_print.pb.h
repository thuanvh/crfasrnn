...
#ifndef PROTOBUF_crfasrnn_5fcaffe_5fpretty_5fprint_2eproto__INCLUDED
#define PROTOBUF_crfasrnn_5fcaffe_5fpretty_5fprint_2eproto__INCLUDED
...
void CAFFE_DLL_EXPORT protobuf_AddDesc_crfasrnn_5fcaffe_5fpretty_5fprint_2eproto();
...
class CAFFE_DLL_EXPORT NetParameterPrettyPrint : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:crfasrnn_caffe.NetParameterPrettyPrint)
 private:
  ...
  friend void CAFFE_DLL_EXPORT protobuf_AddDesc_crfasrnn_5fcaffe_5fpretty_5fprint_2eproto();
  friend void protobuf_AssignDesc_crfasrnn_5fcaffe_5fpretty_5fprint_2eproto();
  friend void protobuf_ShutdownFile_crfasrnn_5fcaffe_5fpretty_5fprint_2eproto();
...
inline const ::crfasrnn_caffe::LayerParameter& NetParameterPrettyPrint::layers(int index) const {
  // @@protoc_insertion_point(field_get:crfasrnn_caffe.NetParameterPrettyPrint.layers)
  return layers_.Get(index);
}
inline ::crfasrnn_caffe::LayerParameter* NetParameterPrettyPrint::mutable_layers(int index) {
  // @@protoc_insertion_point(field_mutable:crfasrnn_caffe.NetParameterPrettyPrint.layers)
  return layers_.Mutable(index);
}
inline ::crfasrnn_caffe::LayerParameter* NetParameterPrettyPrint::add_layers() {
...
#endif  // PROTOBUF_crfasrnn_5fcaffe_5fpretty_5fprint_2eproto__INCLUDED
